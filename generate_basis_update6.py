...
os.environ["CUDA_VISIBLE_DEVICES"]="1" # for debugging purposes to only run on one gpu
...
def ablation_sampler(
    ...
    for i, (t_cur, t_next) in enumerate(zip(t_steps[:-1], t_steps[1:])): # 0, ..., N-1
        ...
        likelihood_step_size = 15 # weighting to the likelihood grad
...
@click.option('--outdir',                  help='Where to save the output images', metavar='DIR',                   type=str, required=True, default = 'out_6channel_DPS')
